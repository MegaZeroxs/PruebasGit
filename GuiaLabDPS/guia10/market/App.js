...
class PantallaInicio extends React.Component {
  ...
  Entrar() {
    if (!!this.state.usuario && !!this.state.contrasena) {
      fetch('http://192.168.1.3/apiusuario.php?comando=autenticar&usuario=' + this.state.usuario + '&contrasena=' + this.state.contrasena, { method: 'GET' })
...
class listarProductos extends React.Component {
  ...
  cargarRegistros() {
    console.log('Prueba');
    fetch('http://192.168.1.3/api.php?comando=listar', {
      method: 'GET'
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaDetalle extends React.Component {
  ...
  Actualizar() {
    ...
    fetch('http://192.168.1.3/api.php?comando=editar&nombre=' + this.state.nombre
  ...
  Eliminar() {
    ...
    fetch('http://192.168.1.3/api.php?comando=eliminar&id=' + this.state.id, {
      method: 'GET'
    })
      .then((response) => response.json())
      .then((responseJson) => {
...
class PaginaAgregar extends React.Component {
  ...
  Guardar() {
    ...
    fetch('http://192.168.1.3/api.php?comando=agregar&nombre=' +
      this.state.nombre
      + '&descripcion=' + this.state.descripcion
      + '&cantidad=' + this.state.cantidad
      + '&preciodecosto=' + this.state.preciodecosto
